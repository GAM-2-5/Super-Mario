...
pauza = False
br_pauza = 0
# TODO: napraviti mogućnost pauziranja igre
...
while run:
    ...
    if Mario.hitbox[1] < neprijatelj.hitbox[1] + neprijatelj.hitbox[3] and Mario.hitbox[1] + Mario.hitbox[3] > \
            neprijatelj.hitbox[1]:  # sudar
        if Mario.hitbox[0] + Mario.hitbox[2] > neprijatelj.hitbox[0] and Mario.hitbox[0] < neprijatelj.hitbox[0] + \
                neprijatelj.hitbox[2]:
            Mario.hit()
    ...
    for metak in municija:  # pucanje
        ...
        if metak.y - metak.radius < neprijatelj.hitbox[1] + neprijatelj.hitbox[3] and metak.y + metak.radius > \
                neprijatelj.hitbox[1]:  # pogodak
            if metak.x + metak.radius > neprijatelj.hitbox[0] and metak.x - metak.radius < neprijatelj.hitbox[0] + \
                    neprijatelj.hitbox[2]:
                brojač_pogodaka += 1
                municija.pop(municija.index(metak))

        if metak.y - metak.radius < riba.hitbox[1] + riba.hitbox[3] and metak.y + metak.radius > riba.hitbox[
            1]:  # pogodak
    ...
    if tipka[pygame.K_LEFT] and brojač2 == 0:
        ...
        try:
            ...
            gljiva.gljiva_hod = [pygame.image.load('Resursi\Sprites\Mario\gljiva1.png'),
                                 pygame.image.load('Resursi\Sprites\Mario\gljiva2.png')]
        ...
        try:
            ...
            riba.riba_desno = [pygame.image.load('Resursi\Sprites/Mario/riba 1 obrnuta.png'),
                               pygame.image.load('Resursi\Sprites/Mario/riba 2 obrnuta.png')]
            riba.riba_lijevo = [pygame.image.load('Resursi\Sprites/Mario/riba 1.png'),
                                pygame.image.load('Resursi\Sprites/Mario/riba 2.png')]
        ...
        try:
            desni_hod = [pygame.image.load('Custom\mario.png'), pygame.image.load('Custom\mario.png'),
                         pygame.image.load('Custom\mario.png'), pygame.image.load('Custom\mario.png')]
            lijevi_hod = [pygame.image.load('Custom\mario.png'), pygame.image.load('Custom\mario.png'),
                          pygame.image.load('Custom\mario.png'), pygame.image.load('Custom\mario.png')]
            idle = pygame.image.load('Custom\mario.png')
            fail = pygame.image.load('Custom\mario.png')
        except:
            desni_hod = [pygame.image.load('Resursi\Sprites\Mario\mario 1.png'),
                         pygame.image.load('Resursi\Sprites\Mario\mario 2.png'),
                         pygame.image.load('Resursi\Sprites\Mario\mario 3.png'),
                         pygame.image.load('Resursi\Sprites\Mario\mario 4.png')]
            lijevi_hod = [pygame.image.load('Resursi\Sprites\Mario\mario 1 obrnuti.png'),
                          pygame.image.load('Resursi\Sprites\Mario\mario 2 obrnuti.png'),
                          pygame.image.load('Resursi\Sprites\Mario\mario 3 obrnuti.png'),
                          pygame.image.load('Resursi\Sprites\Mario\mario 4 obrnuti.png')]
        ...
        try:
            ...
            riba_desno = [pygame.image.load('Resursi\Sprites/Mario/riba 1 obrnuta.png'),
                          pygame.image.load('Resursi\Sprites/Mario/riba 2 obrnuta.png')]
            riba_lijevo = [pygame.image.load('Resursi\Sprites/Mario/riba 1.png'),
                           pygame.image.load('Resursi\Sprites/Mario/riba 2.png')]
    ...
    if tipka[pygame.K_RIGHT] and brojač2 == 0:
        ...
        try:
            ...
            gljiva.gljiva_hod = [pygame.image.load('Resursi\Sprites\Blitzkrieg\gljiva1.png'),
                                 pygame.image.load('Resursi\Sprites\Blitzkrieg\gljiva2.png')]
        neprijatelj.y = 400
        Mario.y = 400
        riba.y = 190
        for i in range(len(gljiva.gljiva_hod)):
        ...
        try:
            ...
            riba.riba_desno = [pygame.image.load('Resursi\Sprites/Blitzkrieg/riba 1 obrnuta.png'),
                               pygame.image.load('Resursi\Sprites/Blitzkrieg/riba 2 obrnuta.png')]
            riba.riba_lijevo = [pygame.image.load('Resursi\Sprites/Blitzkrieg/riba 1.png'),
                                pygame.image.load('Resursi\Sprites/Blitzkrieg/riba 2.png')]
        ...
        try:
            ...
            desni_hod = [pygame.image.load('Resursi\Sprites\Blitzkrieg\mario 1.png'),
                         pygame.image.load('Resursi\Sprites\Blitzkrieg\mario 2.png'),
                         pygame.image.load('Resursi\Sprites\Blitzkrieg\mario 3.png'),
                         pygame.image.load('Resursi\Sprites\Blitzkrieg\mario 4.png')]
            lijevi_hod = [pygame.image.load('Resursi\Sprites\Blitzkrieg\mario 1 obrnuti.png'),
                          pygame.image.load('Resursi\Sprites\Blitzkrieg\mario 2 obrnuti.png'),
                          pygame.image.load('Resursi\Sprites\Blitzkrieg\mario 3 obrnuti.png'),
                          pygame.image.load('Resursi\Sprites\Blitzkrieg\mario 4 obrnuti.png')]
    ...
    if tipka[pygame.K_SPACE] and shootLoop == 0:  # pucanje
        ...
        if len(municija) < 1:
            fireball.play()
            municija.append(
                projektil(round(Mario.x + Mario.width // 2), round(Mario.y + Mario.height // 2), 6, (0, 0, 0), smjer))
    ...
    if tipka[pygame.K_TAB] and br_pauza % 2 != 0:
        pauza = True
        br_pauza += 1
    else:
        pauza = False
